...
Proje kokunde onayli dosyalar varsa run klasorune kopyalanir; yoksa sabit
tr-TR template yazilir. Template marker'i kalan veya bos dosyalar
`waiting_for_input` sonucunu uretir ve bu durum ihlal sayilmaz.
